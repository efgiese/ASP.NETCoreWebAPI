...
namespace ASP.NETCoreWebAPI.Migrations
{
    ...
    [Migration("20190517174237_ExtendDataModel")]
    partial class ExtendDataModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.CourseCover", b =>
                {
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.CourseTag", b =>
                {
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.Course", b =>
                {
                    b.HasOne("ASP.NETCoreWebAPI.Model.Author", "Author")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.CourseCover", b =>
                {
                    b.HasOne("ASP.NETCoreWebAPI.Model.Course", "Course")
                        .WithOne("Cover")
                        .HasForeignKey("ASP.NETCoreWebAPI.Model.CourseCover", "CoverOfCourseId")
            ...
            modelBuilder.Entity("ASP.NETCoreWebAPI.Model.CourseTag", b =>
                {
                    ...
                    b.HasOne("ASP.NETCoreWebAPI.Model.Tag", "Tag")
                        .WithMany("CourseTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
